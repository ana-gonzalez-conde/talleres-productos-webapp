...
namespace Model
{
    ...
    public partial class Category
    {
        ...
        /// <summary>
        /// Relationship Name (Foreign Key in ER-Model): FK__Category__parent__24927208
        /// </summary>
    	...
    	public override int GetHashCode()
    	{
    	    unchecked
    	    {
    			...
    			hash = hash * multiplier + (parentId == null ? 0 : parentId.GetHashCode());
    	...
    	public override String ToString()
    	{
           ...
           strCategory.Append(" parentId = " + parentId + " | " );       
            strCategory.Append("] ");    
