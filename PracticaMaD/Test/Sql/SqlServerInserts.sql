...
VALUES 
('Aceites y lubricantes', NULL),
('Filtros', NULL),
('Baterías', NULL),
('Frenos', NULL),
('Neumáticos', NULL),
('Refrigerantes', NULL),
('Refrigerantes azules', 6);

-- Wrench Set
INSERT INTO Product (name, price, addingDate, stock, image, description, categoryId)
VALUES ('Wrench Set', 49.99, '2024-03-24', 20, 'wrench_set.jpg', 'A set of high-quality wrenches for various sizes.', 1);
...
-- Power Drill
INSERT INTO Product (name, price, addingDate, stock, image, description, categoryId)
VALUES ('Power Drill', 79.99, '2024-03-25', 15, 'power_drill.jpg', 'Versatile power drill for various DIY projects.', 1);
...
-- Car Wax
INSERT INTO Product (name, price, addingDate, stock, image, description, categoryId)
VALUES ('Car Wax', 14.99, '2024-03-27', 50, 'car_wax.jpg', 'Protective wax for a shiny and clean car finish.', 2);
...
-- Floor Mats
INSERT INTO Product (name, price, addingDate, stock, image, description, categoryId)
VALUES ('Floor Mats', 29.99, '2024-03-27', 40, 'floor_mats.jpg', 'Durable floor mats to protect your car interior.', 2);
...
-- Jumper Cables
INSERT INTO Product (name, price, addingDate, stock, image, description, categoryId)
VALUES ('Jumper Cables', 24.99, '2024-03-28', 25, 'jumper_cables.jpg', 'Essential for jump-starting your car in emergencies.', 1);
...
-- Jumper Cables 2
INSERT INTO Product (name, price, addingDate, stock, image, description, categoryId)
VALUES ('Jumper Cables', 27.99, '2024-03-29', 25, 'jumper_cables_2.jpg', 'Essential for jump-starting your car in emergencies.', 7);

INSERT INTO SpecificProperty (name, value, productId)
VALUES ('Length', '13 feet', SCOPE_IDENTITY()),
       ('Gauge', '6 Gauge', SCOPE_IDENTITY());
