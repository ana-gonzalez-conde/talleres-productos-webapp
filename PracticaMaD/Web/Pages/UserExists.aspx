...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_MenuExplanation" runat="server">
    <asp:HyperLink ID="lnkMainPage" runat="server" NavigateUrl="~/Pages/SearchProducts.aspx" meta:resourcekey="lnkMainPageResource1">MainPage</asp:HyperLink> - <asp:Label ID="lblSearchUser" runat="server" Text="<%$Resources: , lblExplanation_txt %>"></asp:Label>
</asp:Content>
